...
async function pull_user(user: DatabaseUser): Promise<DatabaseUser> {
    ...
    return new Promise((resolve, reject) => {
        fetch(`${process.env.NEXTAUTH_URL}/api/database/getUserAccount`, request)
        .then(res => res.json())
        .then((resj) => {
...
async function check_user_exists(email: string): Promise<boolean> {
    ...
    return new Promise((resolve, reject) => {
        fetch(`${process.env.NEXTAUTH_URL}/api/database/checkForUser`, request)
        .then(res => res.json())
        .then((resj) => {
...
function create_account(userAccount: DatabaseUser) {
    ...
    fetch(`${process.env.NEXTAUTH_URL}/api/database/createUser`, create_account_req)
    .then(res => res.json())
    .then(resj => {
